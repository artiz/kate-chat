...
export class ChatDefaults1760707239589 implements MigrationInterface {
  name = "ChatDefaults1760707239589";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "users"("id", "email", "password", "firstName", "lastName", "role", "defaultModelId", "defaultSystemPrompt", "avatarUrl", "googleId", "githubId", "authProvider", "createdAt", "updatedAt", "modelsCount", "settings", "documentsEmbeddingsModelId", "documentSummarizationModelId", "chatsCount") SELECT "id", "email", "password", "firstName", "lastName", "role", "defaultModelId", "defaultSystemPrompt", "avatarUrl", "googleId", "githubId", "authProvider", "createdAt", "updatedAt", "modelsCount", "settings", "documentsEmbeddingsModelId", "documentSummarizationModelId", "chatsCount" FROM "temporary_users"`,
    );
