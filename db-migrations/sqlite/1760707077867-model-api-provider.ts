...
export class ModelApiProvider1760707077867 implements MigrationInterface {
  name = "ModelApiProvider1760707077867";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_models"("id", "name", "modelId", "description", "userId", "provider", "apiProvider", "isActive", "isCustom", "createdAt", "updatedAt", "type", "streaming", "imageInput", "maxInputTokens", "tools") SELECT "id", "name", "modelId", "description", "userId", "provider", "apiProvider", "isActive", "isCustom", "createdAt", "updatedAt", "type", "streaming", "imageInput", "maxInputTokens", "tools" FROM "models"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "models"("id", "name", "modelId", "description", "userId", "provider", "apiProvider", "isActive", "isCustom", "createdAt", "updatedAt", "type", "streaming", "imageInput", "maxInputTokens", "tools") SELECT "id", "name", "modelId", "description", "userId", "provider", "apiProvider", "isActive", "isCustom", "createdAt", "updatedAt", "type", "streaming", "imageInput", "maxInputTokens", "tools" FROM "temporary_models"`,
    );
