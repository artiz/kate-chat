...
export type ApiMode = "completions" | "realtime";
...
export const SettingsForm: React.FC<SettingsFormProps> = ({
  ...
  const handleSave = () => {
    ...
    onSave({ apiKey, apiEndpoint: endpoint, modelName });
  };
  ...
  return (
    <Stack gap="md">
      <Text size="sm" c="dimmed">
        Configure your OpenAI Realtime API settings. Your API key is stored
