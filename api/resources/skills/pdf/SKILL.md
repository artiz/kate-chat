...
Use this skill when the user wants a PDF: a report, a letter, an invoice, a summary, a one-pager. Describe the document as a pdfmake document definition and render it with the helper `skill/pdf.js`, which loads fonts that cover Latin, Cyrillic and Greek text.
