...
Vendored from https://github.com/artiz/fleischwolf (scripts/export_tableformer.py)
so the document-processor image can build the models without cloning the upstream repo.
