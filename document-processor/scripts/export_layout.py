...
Vendored from https://github.com/artiz/fleischwolf (scripts/export_layout.py) so
the document-processor image can build the model without cloning the upstream repo.
