...
export default function ModelsPage() {
  ...
  // Get all providers
  const providers = providersData?.getModelProviders || [];
  const models = modelsData?.getModels || [];
                        ...
                        <Card shadow="sm" padding="lg" radius="md" withBorder>
                          ...
                          <Group justify="space-between" mt="md">
                            <Group gap="xs">
                              ...
                              <Tooltip
                                label={`Input: $${model.inputCostPer1KTokens}/1K tokens, Output: $${model.outputCostPer1KTokens}/1K tokens`}
                              >
