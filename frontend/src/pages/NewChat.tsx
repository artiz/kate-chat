...
import { Container, Title, Paper, Select, Button, Group, TextInput, Textarea, Stack } from "@mantine/core";
        ...
        <Paper withBorder p="xl">
          <Stack gap="md">
            ...
            <Group p="right" mt="xl">
              ...
              <Button type="submit" disabled={!selectedModelId || loading} loading={loading}>
                Create Chat
              </Button>
            </Group>
          </Stack>
